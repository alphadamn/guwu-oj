...
class PointConfig(models.Model):
    ...
    accepted_testcase_points = models.DecimalField(
        'AC 测试点奖励积分', max_digits=14, decimal_places=4, default=0,
...
class PointLedgerEntry(models.Model):
    ...
    amount = models.DecimalField('积分变动', max_digits=14, decimal_places=4)
    balance_after = models.DecimalField('变动后余额', max_digits=14, decimal_places=4)
